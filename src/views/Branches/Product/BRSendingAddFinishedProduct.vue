<template>
  <section class="BRSendingAddFinishedProduct">
    <div class="breadcrumb p-0">
      <div class="breadcrumb__item">
        <router-link :to="{name: 'BRSendingFinishedProduct'}" class="breadcrumb__link">
